...
string.""", formatter_class=argparse.RawTextHelpFormatter)
    ...
    parser.add_argument('groundtruths', type=str, help='Directory containing ground truth files.') # gt.txt
    parser.add_argument('tests', type=str, help='Directory containing tracker result files') # track.txt

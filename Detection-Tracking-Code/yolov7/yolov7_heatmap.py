...
def get_params():
    params = {
        'weight': 'runs/train/yolov7x_30/weights/best.pt', # 自己训练的模型权重文件
        'cfg': 'cfg/training/yolov7x.yaml', # 模型的配置文件
        'device': 'cuda:0', # 使用gpu
...
if __name__ == '__main__':
    ...
    model('inference/images/01_short_12.jpg', 'vis_result') # 需要可视化热力图的图片路径以及保存路径
